...
# The algorithm will generate between 1 and 500 different words and x sample sentences based upon the x most used sentences in English both in the present, past and future.
